public class  OldId extends Id{
    boolean isOldId(String idNumber){
        boolean oldOrNot=true;
        if(idNumber.length()!=10){
            oldOrNot=false;
        }
        
        else if(idNumber.length()==10 && (idNumber.charAt(9)=='v'||idNumber.charAt(9)=='V')){
            oldOrNot=true;
        }
    ...
    void BirthDay(String idNumber){
        ...
        year="19"+String.valueOf(idNumber.charAt(0))+String.valueOf(idNumber.charAt(1));
